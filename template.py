...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Lưu ý khi gọi API trực tiếp: {e}")
        print("(Nếu API key OpenAI của bạn đã hết credit, bạn có thể lấy key miễn phí từ NVIDIA NIM theo Phụ lục B trong LAB_GUIDE.md)")

    print("\n=== Trợ lý CLI (gõ 'quit' hoặc 'exit' để thoát) ===")
    try:
        stats = run_assistant(
        ...
        print(f"Lưu ý trong phiên trợ lý: {e}")
